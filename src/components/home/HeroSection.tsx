  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroBg}
          alt="SAWA 3D Fashion Technology"
      ...
      <div className="container relative z-10 px-6 py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-cream-muted mb-12 max-w-2xl mx-auto font-light"
          >
            Create one-of-a-kind fashion pieces with our revolutionary 3D customizer. 
            Your style, your rules, your identity.
          </motion.p>
